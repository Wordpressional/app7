...
<a href="{{route('cadmin.stables.index')}}" class="btn btn-primary btn-sm align-self-center"><b>Back</b></a>

  
   <a href="#" id="UpdateJSON1" class="btn btn-primary btn-sm align-self-center form-builder-save"><b>Update Table Name</b></a> 


   <a href="{{route('cadmin.stables.contexportcsv',['id'=>$stablescform->id])}}" class="btn btn-primary btn-sm align-self-center somecsvfile"><b>Download CSV</b></a>
  ...
  var tablename = $('#tablename').val();
     ...
     var data = JSON.stringify({
      ...
      $.ajax({
            ...
            url: "{{route('cadmin.stables.update',['id'=>$stablescform->id])}}",
              ...
              $('#successalert').css("display", "block");
                 ...
                 setTimeout(function(){ 
                  ...
                  $('#successalert').css("display", "none"); 
                   ...
                   var newLocation = "{{ url('/cadmin/stables') }}";
  ...
  var tablename = $('#tablename').val();
     ...
     var data = JSON.stringify({
      ...
      $.ajax({
            ...
            url: "{{route('cadmin.stables.updatetablename',['id'=>$stablescform->id])}}",
