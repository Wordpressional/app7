{!! Form::model($comment, ['route' => ['cadmin.comments.update', $comment], 'method' =>'PUT' ]) !!}
    ...
    <div class="pull-left">
        {{ link_to_route('cadmin.comments.index', __('forms.actions.back'), [], ['class' => 'btn btn-secondary']) }}
        {!! Form::submit(__('forms.actions.update'), ['class' => 'btn btn-primary']) !!}
    </div>

{!! Form::close() !!}

{!! Form::model($comment, ['method' => 'DELETE', 'route' => ['cadmin.comments.destroy', $comment], 'class' => 'form-inline pull-right', 'data-confirm' => __('forms.comments.delete')]) !!}
