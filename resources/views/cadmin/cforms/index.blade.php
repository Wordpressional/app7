...
<div class="page-header d-flex justify-content-between">
      ...
      <a href="{{ route('cadmin.cforms.create') }}" class="btn btn-primary btn-sm align-self-center">
						...
						@if($cforms->count())
						 @foreach($cforms as $cform)
			              ...
			              <tr>
			              	...
			              	<a class="btn btn-info" href="{{ route('cadmin.cforms.edit',['id'=>$cform->id]) }}">
			              	...
			              	<a class="btn btn-warning" href="{{ route('cadmin.cforms.preview',['id'=>$cform->id]) }}">
			              	...
			              	<td>
			              	@if($cform->trashed())
			              	<a class="btn btn-warning" href="{{ route('cadmin.cforms.restore',['id'=>$cform->id]) }}">
			              	
			              			<i class="fa fa-repeat" aria-hidden="true"></i>
			              	</a>
			              	<a class="btn btn-danger" href="{{ route('cadmin.cforms.delete',['id'=>$cform->id]) }}">
