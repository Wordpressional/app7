    ...
    $(".del-button").click(function(){
        ...
        var colcount = '{{ $cform->colcount }}' ;
          ...
          $.ajax({
                ...
                url: "{{route('cadmin.cforms.remcolftable',['id'=>$cform->id])}}",
    ...
    //alert(countarr);
     ...
     var data = JSON.stringify({
      ...
      $.ajax({
            ...
            url: "{{route('cadmin.cforms.update',['id'=>$cform->id])}}",
      ...
      $.ajax({
            ...
            url: "{{route('cadmin.cforms.ucolcount',['id'=>$cform->id])}}",
     ...
     var data = JSON.stringify({
      ...
      $.ajax({
            ...
            url: "{{route('cadmin.cforms.operate',['id'=>$cform->id])}}",
            ...
            success: function(result) {
              $('#successalert').css("display", "block");
                 ...
                 setTimeout(function(){ $('#successalert').css("display", "none");
                   ...
                   var newLocation = "{{ url('/cadmin/cforms') }}";
