...
@endif
 ...
 <center><div  class=" successalert" style="color:green; background-color:white; border-radius:5px; padding:5px; margin-top:20px;"><a href="{{route('cadmin.themepreview')}}" target="_blank">Preview</a></div></center>
       ...
       // alert(slug);
        ...
        arrasson =  {"newtheme": newtheme,  "tid": tid};
         ...
         $.ajax({
                ...
                url: "{{route('cadmin.activatetheme')}}",
       ...
       // alert(slug);
        ...
        arrasson =  {"newtheme": newtheme,  "tid": tid};
         ...
         $.ajax({
                ...
                url: "{{route('cadmin.deactivatetheme')}}",
