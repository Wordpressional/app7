            ...
            @if($module->count())
             @foreach($module as $module)
                    ...
                    <tr>
                      ...
                      <a class="btn btn-warning" href="{{ route('cadmin.module.activate',['id'=>$module->id]) }}">
                      
                          <span><i class="fa fa-toggle-on" aria-hidden="true"></i> Activate</span>
                      </a>
                            
                           @else
                       <a class="btn btn-warning" href="{{ route('cadmin.module.deactivate',['id'=>$module->id]) }}">
                      ...
                      <td>
                       ...
                       @if($module->mmstatus == "inactive")
                       @else
                      <a class="btn btn-danger" href="{{ route('cadmin.module.install',['id'=>$module->id]) }}">
                      ...
                      <a class="btn btn-danger" href="{{ route('cadmin.module.uninstall',['id'=>$module->id]) }}">
...
<div class="page-header d-flex justify-content-between loadmodules">
      ...
      <a href="{{ route('cadmin.module.dumpmodules') }}" class="btn btn-primary btn-sm align-self-center">
