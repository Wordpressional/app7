...
<div onclick="writefiles('{{route('cadmin.widgetcustupdate')}}')" class="btn btn-primary btn-sm align-self-center writefile"><b>Update</b></div>
@endsection
@section('scripts')
           ...
           //}
            ...
            if(result == "success"){
              alert("successfully updated custom widget");
                var newLocation = "{{ url('/cadmin/widgetcusteditor') }}";
