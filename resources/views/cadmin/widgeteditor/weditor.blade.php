...
<!--<div onclick="writefiles('{{route('cadmin.widgetupdate')}}')" class="btn btn-primary btn-sm align-self-center writefile"><b>Update</b></div>-->
           ...
           //}
            ...
            if(result == "success"){
              alert("successfully updated widget");
                var newLocation = "{{ url('/cadmin/widgeteditor') }}";
