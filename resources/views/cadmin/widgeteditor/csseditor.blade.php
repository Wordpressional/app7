...
<option value="">- Select stylesheet file -
<?php 
...
<div onclick="writefilescss('{{route('cadmin.cssupdate')}}')" class="btn btn-primary btn-sm align-self-center writefile"><b>Update</b></div>
@endsection
@section('scripts')
<script type="text/javascript">
 

        function writefilescss(newLocation)
        {
           ...
           //}
            ...
            if(result == "success"){
              alert("successfully updated widget");
                var newLocation = "{{ url('/cadmin/csseditor') }}";
