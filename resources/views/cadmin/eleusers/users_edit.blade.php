@extends('cadmin.layouts.cadminpages')
...
@section('content')
   ...
   <!-- <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    ...
    <a class="btn btn-sm btn-primary moveright" href="{{route('cadmin.polling.displayusers')}}">Back</a>
    <h2>{{$title}}</h2>
<hr>
  ...
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    ...
    @endif
    <form method="post" action="{{ route('cadmin.eleusers.updateelec', ['id' => $user->id]) }}" data-parsley-validate class="form-horizontal form-label-left">
