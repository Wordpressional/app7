...
@section('content')
 ...
 <div class="page-header d-flex justify-content-between">
      ...
      <a href="{{ route('cadmin.category.create') }}" class="btn btn-primary btn-sm align-self-center">
						...
						@if($categories->count())
						 @foreach($categories as $category)
			              ...
			              <tr>
			              	...
			              	@else
			              	<a class="btn btn-info" href="{{ route('cadmin.category.edit',['id'=>$category->id]) }}">
			              	...
			              	<td>
			              	@if($category->trashed())
			              	<a class="btn btn-warning" href="{{ route('cadmin.category.restore',['id'=>$category->id]) }}">
			              	
			              			<i class="fa fa-repeat" aria-hidden="true"></i>
			              	</a>
			              	<a class="btn btn-danger" href="{{ route('cadmin.category.delete',['id'=>$category->id]) }}">
