...
@endif
    ...
    {!! Form::model($page, ['route' => ['cadmin.pages.update', $page], 'method' =>'PUT', 'files' => true]) !!}
    ...
    {!! Form::model($page, ['method' => 'DELETE', 'route' => ['cadmin.pages.destroy', $page], 'class' => 'form-inline pull-right', 'data-confirm' => __('forms.pages.delete')]) !!}
