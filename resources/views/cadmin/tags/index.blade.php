...
<div class="page-header d-flex justify-content-between">
      ...
      <a href="{{ route('cadmin.tags.create') }}" class="btn btn-primary btn-sm align-self-center">
						...
						@if($tags->count())
						 @foreach($tags as $tag)
			              ...
			              <tr>
			              	...
			              	<a class="btn btn-info" href="{{ route('cadmin.tags.edit',['id'=>$tag->id]) }}">
			              	...
			              	<td>
			              	@if($tag->trashed())
			              	<a class="btn btn-warning" href="{{ route('cadmin.tags.restore',['id'=>$tag->id]) }}">
			              	
			              			<i class="fa fa-repeat" aria-hidden="true"></i>
			              	</a>
			              	<a class="btn btn-danger" href="{{ route('cadmin.tags.delete',['id'=>$tag->id]) }}">
