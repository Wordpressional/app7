...
<section class="ecartnatheme1 carttheme1">
            ...
            <div class="pull-right">
                <ul class="nav navbar-nav navbar-right">
                    @if(Auth::guard('checkout')->check())
                        <li><a href="{{ route('accountse1', ['tab' => 'profile']) }}"><i class="fa fa-home"></i> My Account</a></li>
                        <li><a href="{{ route('logout') }}"><i class="fa fa-sign-out"></i> Logout</a></li>
                    @else
                        <li><a href="{{ route('cart.custe1login') }}"> <i class="fa fa-lock"></i> Login</a></li>
        ...
        <nav class="navbar navbar-default">
            <div class="container">
                ...
                <div class="navbar-header col-md-2">
					...
					<img id="imagePreviewmpoltheme1" src="{{ asset('img/pwalogo.png')}}" alt="" title=""/>
					</a>
                </div>
                <div class="col-md-10">
