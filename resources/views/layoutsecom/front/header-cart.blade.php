...
<div class="ecartnatheme1 collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        @else
            <li class="visible-xs"><a href="{{ route('cart.custlogin') }}"> <i class="fa fa-lock"></i> Login</a></li>
            <li class="visible-xs"><a href="{{ route('cart.custreg') }}"> <i class="fa fa-sign-in"></i> Register</a></li>
        @endif
