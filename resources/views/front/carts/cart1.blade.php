                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="{{ route('checkoute1.index', ['from' => 'cart1', 'package' => 'startup']) }}" class="btn btn-primary">Go to checkout</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 content">
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($cartItems as $cartItem)
                                <tr>
                                    <td>
                                        <a href="{{ route('front.get.themeproduct', [$cartItem->product->slug]) }}" class="hover-border">
                                            @if(isset($cartItem->cover))
                                                <img src="{{$cartItem->cover}}" alt="{{ $cartItem->name }}" class="img-responsive img-thumbnail">
                                            @else
                                                <img src="https://placehold.it/120x120" alt="" class="img-responsive img-thumbnail">
