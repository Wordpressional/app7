                ...
                <div class="box-body">
                    ...
                    @if(!$addresses->isEmpty())
                        ...
                        @foreach ($addresses as $address)
                            <tr>
                                <td><a href="{{ route('admin.customers.show', $customerid) }}">{{ $address->alias }}</a></td>
                        ...
                        <a href="{{ route('accountse1', ['tab' => 'profile']) }}" class="btn btn-default">Back to My Account</a>
                    @else
                        <p class="alert alert-warning">No address created yet. <a href="{{ route('customere1.address.create', auth()->id()) }}">Create</a></p>
                    @endif
                </div>
                <!-- /.box-body -->
            </div>
