...
<a href="{{route('admin.forms.smanagement')}}" class="btn btn-primary btn-sm align-self-center"><b>Back</b></a>
  ...
  var shortcode = $('#shortcode').val();
     ...
     var data = JSON.stringify({
      ...
      $.ajax({
            ...
            url: "{{route('admin.forms.updateshortcode',['id'=>$form->id])}}",
              ...
              $('#successalert').css("display", "block");
                 ...
                 setTimeout(function(){ 
                  ...
                  $('#successalert').css("display", "none"); 
                   ...
                   var newLocation = "{{ url('/admin/forms/smanagement') }}";
