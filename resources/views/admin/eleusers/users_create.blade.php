@extends('admin.layouts.adminpages') @section('content')
...
<main role="main" class="col-md-12 ml-sm-auto col-lg-12 pt-3 px-4">
    ...
    <a class="btn btn-sm btn-primary moveright" href="{{route('admin.eleusers')}}">Back</a>
    <h2>{{$title}}</h2>
    <form method="post" action="{{ route('admin.eleusers.store') }}" data-parsley-validate class="form-horizontal form-label-left">
