...
<main role="main" class="col-md-12 ml-sm-auto col-lg-12 pt-3 px-4">
    ...
    <a class="btn btn-sm btn-primary moveright" href="{{route('admin.polling.createeleusers')}}">Back</a>
    <h2>Create Users</h2>
    <hr>
  ...
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    ...
    @endif
    <form method="post" action="{{ route('admin.polling.storecsv') }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
     ...
     <form method="post" action="{{ route('admin.polling.importcsv') }}" data-parsley-validate class="form-horizontal form-label-left">
