    ...
    <tbody>
        @foreach($pages as $page)
            <tr>
                ...
                <td>@if($thisuser->isCMSAdmin() == "yes" || $thisuser->isSAdmin() == "yes" || $thisuser->isSuperadministrator() == "yes") {{ link_to_route('admin.authors.edita', $page->author->name, $page->author) }} @else {{ $page->author->name }} @endif</td>
