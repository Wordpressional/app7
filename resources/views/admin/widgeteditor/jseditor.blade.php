...
<div onclick="writefilesjs('{{route('admin.jsupdate')}}')" class="btn btn-primary btn-sm align-self-center writefile"><b>Update</b></div>
@endsection
@section('scripts')
           ...
           //}
            ...
            if(result == "success"){
              alert("successfully updated widget");
                var newLocation = "{{ url('/admin/jseditor') }}";
