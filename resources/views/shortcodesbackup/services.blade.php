<div class="ani1 boxmlservicetheme1 textmlservicetheme1">
<span class="editmlservicetheme1">edit</span>
  
<span class="savemlservicetheme1">save</span>
<h2>Our Services</h2>

    <span class="editpresentationcolor">Color</span>
...
<section class="presentation">
          ...
          <div class="container">
                ...
                <div class="left sidepurple boxmlservicetheme2 textmlservicetheme2">
                    <span class="service-icon1">
                    <i class="fa fa-desktop" id="pur" aria-hidden="true">&nbsp;</i>
                    </span>
                    <span class="editmlservicetheme2">edit</span>
  
                      <span class="savemlservicetheme2">save</span>
                        <span class="editcontpur">fontawesome</span>
         ...
         <div class="right sidepurple boxmlservicetheme3 textmlservicetheme3">
            <span class="service-icon2">
                    <i class="fa fa-desktop" id="pur2" aria-hidden="true">&nbsp;</i>
                    </span>
                    <span class="editmlservicetheme3">edit</span>
  
                      <span class="savemlservicetheme3">save</span>
                        <span class="editcontpur2">fontawesome</span>
                    ...
                    <p>Decentralized digital currency systems known as cryptocurrencies are a breakthrough in electronic payments: the absence of a central authority can avoid the risk that a not fully reliable, very small transactions can be made without incurring high costs and transactions can be traced. Furthermore, decentralization provides robustness against many attacks.</p>
...
<section class="presentation">
            ...
            <div class="container">
                <div class="left side">
                    ...
                    <ul>
                      <li class="feature currencies boxmlservicetheme4 textmlservicetheme4">
                        <span class="service-icon3">
                    <i class="fa fa-desktop" id="cur" aria-hidden="true">&nbsp;</i>
                    </span>
                        <span class="editmlservicetheme4">edit</span>
  
                      <span class="savemlservicetheme4">save</span>
                       <span class="editcontpur3">fontawesome</span>
                      ...
                      <li class="feature sources boxmlservicetheme5 textmlservicetheme5">
                        <span class="service-icon4">
                    <i class="fa fa-desktop" id="src" aria-hidden="true">&nbsp;</i>
                    </span>
                         <span class="editmlservicetheme5">edit</span>
  
                      <span class="savemlservicetheme5">save</span>
                       <span class="editcontpur4">fontawesome</span>
                      ...
                      <input type="button" value="Submit" class="submitcontpur4">
                        ...
                        <li class="feature security boxmlservicetheme5a textmlservicetheme5a">
                        <span class="service-icon5">
                    <i class="fa fa-desktop" id="sec" aria-hidden="true">&nbsp;</i>
                    </span>
                         <span class="editmlservicetheme5a">edit</span>
  
                      <span class="savemlservicetheme5a">save</span>
                       <span class="editcontpur5">fontawesome</span>
                ...
                <div class="right side">
                    ...
                    <ul>                      
                      <li class="feature docs boxmlservicetheme6 textmlservicetheme6">
                        <span class="service-icon6">
                    <i class="fa fa-desktop" id="doc" aria-hidden="true">&nbsp;</i>
                    </span>
                    <span class="editmlservicetheme6">edit</span>
  
                      <span class="savemlservicetheme6">save</span>
                       <span class="editcontpur6">fontawesome</span>
                      ...
                      <li class="feature historical boxmlservicetheme7 textmlservicetheme7">
                        <span class="service-icon7">
                    <i class="fa fa-desktop" id="hist" aria-hidden="true">&nbsp;</i>
                    </span>
                        <span class="editmlservicetheme7">edit</span>
  
                      <span class="savemlservicetheme7">save</span>
                       <span class="editcontpur7">fontawesome</span>
                      ...
                      <input type="button" value="Submit" class="submitcontpur7">
                        ...
                        <li class="feature powerful boxmlservicetheme7a textmlservicetheme7a">
                        <span class="service-icon8">
                    <i class="fa fa-desktop" id="pow" aria-hidden="true">&nbsp;</i>
                    </span>
                        <span class="editmlservicetheme7a">edit</span>
  
                      <span class="savemlservicetheme7a">save</span>
                       <span class="editcontpur8">fontawesome</span>
