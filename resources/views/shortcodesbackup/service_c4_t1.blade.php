<!-- SERVICE -->
<section id="service" class="service boxpcservices4 textpcservices4 pcserviceypresentation4">
    ...
    <!-- START SINGLE SERVICE DESIGN AREA -->
        <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp " data-wow-delay=".2s" style=" animation-delay: 0.2s; animation-name: none;">
            ...
            <div class="single-service">
                <div class="boxpcservices1 textpcservices1">
                <div class="service-icon">
                  <i id="purpcservices1"  class="fa fa-desktop" aria-hidden="true">&nbsp;</i>
                </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay=".3s" style=" animation-delay: 0.3s; animation-name: none;">
            <div class="single-service">
                <div class="boxpcservices2 textpcservices2">
                <div class="service-icon"><i id="purpcservices2" class="fa fa-paper-plane-o" aria-hidden="true">&nbsp;</i>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay=".4s" style=" animation-delay: 0.4s; animation-name: none;">
            <div class="single-service">
                <div class="boxpcservices3 textpcservices3">
                <div class="service-icon"><i id="purpcservices3" class="fa fa-500px" aria-hidden="true">&nbsp;</i>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay=".5s" style=" animation-delay: 0.5s; animation-name: none;">
            <div class="single-service">
                <div class="boxpcservices5 textpcservices5">
                <div class="service-icon"><i id="purpcservices5" class="fa fa-space-shuttle" aria-hidden="true">&nbsp;</i>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay=".6s" style=" animation-delay: 0.6s; animation-name: none;">
            <div class="single-service">
                 <div class="boxpcservices6 textpcservices6">
                <div class="service-icon">
                  <i  id="purpcservices6" class="fa fa-star" aria-hidden="true">&nbsp;</i>
                </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay=".7s" style=" animation-delay: 0.7s; animation-name: none;">
            <div class="single-service">
                 <div class="boxpcservices7 textpcservices7">
                <div class="service-icon">
                    <i id="purpcservices7" class="fa fa-camera" aria-hidden="true">&nbsp;</i>
                </div>
