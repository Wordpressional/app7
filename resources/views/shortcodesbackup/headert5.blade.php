...
<div class="mpoltheme container main-menu">
	<div class="row align-items-center justify-content-between d-flex">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="#"><a href="#mpolheader">Home</a></li>
          <li><a href="#mpolabout">About</a></li>
          <li><a href="#mpolservice">Service</a></li>
         
          <li><a href="#mpolblog">Blog</a>

          </li>						          
          <li><a href="#mpolgallery">Elements</a></li>				          
          <li><a href="#mpolfooter">Contact</a></li>
        </ul>
