<div class="container">
	<div class="anusnippetgalley row">
		<div class="row">
            <div class="col-lg-3 col-md-4 col-xs-6 thumb boxsnipetimage1">
		<span class="editsnipetimage1">edit</span>
		<span class="savesnipetimage1">save</span>
       <input type='file' id="imageUploadsnipetimage1" accept=".png, .jpg, .jpeg" />
        <label class="imageUploadsnipetimage1" for="imageUploadsnipetimage1">&nbsp;</label>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb boxsnipetimage2">
			<span class="editsnipetimage2">edit</span>
		   <span class="savesnipetimage2">save</span>
          ...
          <label class="imageUploadsnipetimage2" for="imageUploadsnipetimage2">&nbsp;</label>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb boxsnipetimage3">
			<span class="editsnipetimage3">edit</span>
		   <span class="savesnipetimage3">save</span>
          ...
          <label class="imageUploadsnipetimage3" for="imageUploadsnipetimage3">&nbsp;</label>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb boxsnipetimage4">
			 <span class="editsnipetimage4">edit</span>
		   <span class="savesnipetimage4">save</span>
          ...
          <label class="imageUploadsnipetimage4" for="imageUploadsnipetimage4">&nbsp;</label>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb boxsnipetimage5">
			 <span class="editsnipetimage5">edit</span>
		   <span class="savesnipetimage5">save</span>
          ...
          <label class="imageUploadsnipetimage5" for="imageUploadsnipetimage5">&nbsp;</label>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb boxsnipetimage6">
			 <span class="editsnipetimage6">edit</span>
		   <span class="savesnipetimage6">save</span>
          <input type='file' id="imageUploadsnipetimage6"accept=".png, .jpg, .jpeg"/>
          <label class="imageUploadsnipetimage6" for="imageUploadsnipetimage6">&nbsp;</label>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb boxsnipetimage7">
			 <span class="editsnipetimage7">edit</span>
		   <span class="savesnipetimage7">save</span>
          <input type='file' id="imageUploadsnipetimage7" accept=".png, .jpg, .jpeg"/>
          <label class="imageUploadsnipetimage7" for="imageUploadsnipetimage7">&nbsp;</label>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb boxsnipetimage8">
			 <span class="editsnipetimage8">edit</span>
		   <span class="savesnipetimage8">save</span>
          <input type='file' id="imageUploadsnipetimage8" accept=".png, .jpg, .jpeg"/>
          <label class="imageUploadsnipetimage8" for="imageUploadsnipetimage8">&nbsp;</label>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb boxsnipetimage9">
			 <span class="editsnipetimage9">edit</span>
          ...
          <label class="imageUploadsnipetimage9" for="imageUploadsnipetimage9">&nbsp;</label>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb boxsnipetimage10">
			<span class="editsnipetimage10">edit</span>
		   <span class="savesnipetimage10">save</span>
          ...
          <label class="imageUploadsnipetimage10" for="imageUploadsnipetimage10">&nbsp;</label>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb boxsnipetimage11">
			<span class="editsnipetimage11">edit</span>
		   <span class="savesnipetimage11">save</span>
