...
<br /><br />
      ...
      <div class=" row m-auto text-center   boxprice1 textprice1 ">
        
        <div class="col-sm-12 col-md-4 col-lg-4 princing-item myblue ">
          <span class="editprice1">edit</span>
              <span class="saveprice1">save</span>

       
          <div class="pricing-divider ">
 
              <h3 class="text-light">START-UP</h3>
            <h4 class="my-0 display-2 pradeep text-light font-weight-normal mb-3"><span class="h3">$</span> 120 <span class="h5">/mo</span></h4>
