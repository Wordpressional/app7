<div class="themeone">
  ...
  <br>
  <input type="button" value="Submit" data-cke-editable="1" contenteditable="false" class="submitpresentationcolorpccontact4">
  </span>
		<div class="row">
			<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-lg-12">
                  ...
                  <li>
                    ...
                    <input type="button" value="Submit" class="submitmfooterfacebook2">
                    </span>
                ...
                <a href="#your-link"  class="social-icon" id="hrefchangemfooterfacebook2"> 
                  ...
                  <input type="button" value="Submit" class="submitmfootertwitter3">
                    </span>
                ...
                <li>
                  ...
                  <input type="button" value="Submit" class="submitmfooterrss4"">
                    </span>
                ...
                <li>
                  ...
                  <input type="button" value="Submit" class="submitmfooteryoutube5"">
                  </span>
                ...
                <li>
                  ...
                  <input type="button" value="Submit" class="submitmfooterlinkedin6">
                  </span>
                ...
                <li>
                  ...
                  <input type="button" value="Submit" class="submitmfootergoogleplus7">
                  </span>
...
<span class="editpresentationcolorcnfp1">Color</span> 
  ...
  <br>
  <input type="button" value="Submit" data-cke-editable="1" contenteditable="false" class="submitpresentationcolorcnfp1">
  </span>
			<div class="row">
				<div class="col-lg-12">
