<footer id="moxyfooter">
    <div class="boxmoxygentheme101 textmoxygentheme101 moxypresentation101">
  <span class="editpresentationcolormoxygentheme101">Color</span> 
  ...
  <input type="button" value="Submit" data-cke-editable="1" contenteditable="false" class="submitpresentationcolormoxygentheme101" style="color:black;">
    ...
    <div class="moxytheme footer-top wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
      <div class="container text-center">
        <div class="footer-logo">
           <div class="boxmoxygentheme71">
                 <span class="editmoxygentheme71">edit</span>
  
                           <span class="savemoxygentheme71">save</span>
             ...
             <span class="contmoxytwitter73">
                     ...
                     <input type="button" value="Submit" class="submitmoxytwitter73" style="color:black;">
                        ...
                        <span class="boxmoxygentheme73">
                             <span class="editmoxygentheme73">
                              <i class="fa fa-edit">&nbsp;</i>
                            </span>
                    <a class="twitter" href="#" id="hrefchangemoxytwitter73">
             ...
             <span class="contmoxydribbble74">
                     ...
                     <input type="button" value="Submit" class="submitmoxydribbble74" style="color:black;">
                        ...
                        <span class="boxmoxygentheme74">
                             <span class="editmoxygentheme74">
                              <i class="fa fa-edit">&nbsp;</i>
                            </span>
                    <a class="dribbble" href="#" id="hrefchangemoxydribbble74">
                    ...
                    <span class="contmoxyfacebook75">
                     ...
                     <input type="button" value="Submit" class="submitmoxyfacebook75" style="color:black;">
                        ...
                        <span class="boxmoxygentheme75">
                             <span class="editmoxygentheme75">
                              <i class="fa fa-edit">&nbsp;</i>
                            </span>
                    <a class="facebook" href="#" id="hrefchangemoxyfacebook75">
                    ...
                    <span class="contmoxylinkedin76">
                     ...
                     <input type="button" value="Submit" class="submitmoxylinkedin76" style="color:black;">
                        ...
                        <span class="boxmoxygentheme76">
                             <span class="editmoxygentheme76">
                              <i class="fa fa-edit">&nbsp;</i>
                            </span>
                    <a class="linkedin" href="#" id="hrefchangemoxylinkedin76">
                    ...
                    <span class="contmoxytumblrsquare77">
                     ...
                     <input type="button" value="Submit" class="submitmoxytumblrsquare77" style="color:black;">
                        ...
                        <span class="boxmoxygentheme77">
                             <span class="editmoxygentheme77">
                              <i class="fa fa-edit">&nbsp;</i>
                            </span>
                    <a class="tumblrsquare" href="#" id="hrefchangemoxytumblrsquare77">
    ...
    <div class="moxytheme footer-bottom">
   <div class="boxmoxygentheme102 textmoxygentheme102 moxypresentation102">
   <span class="editmoxygentheme102">edit</span>
    
  <span class="savemoxygentheme102">save</span>
  <span class="editpresentationcolormoxygentheme102">Color</span> 
  ...
  <input type="button" value="Submit" data-cke-editable="1" contenteditable="false" class="submitpresentationcolormoxygentheme102">
      ...
      <div class="container">
          ...
          <div class="col-sm-6 col-md-6 fl">
