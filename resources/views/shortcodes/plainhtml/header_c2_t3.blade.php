<header id="mlheader" class="mlthemeone  boxmlthemeone70">
        
               <span class="editmlthemeone70">edit</span>
  
                           <span class="savemlthemeone70">save</span>
                       <span class="labelmlthemeone70"><label class="imageUploadmlthemeone70" for="imageUploadmlthemeone70">&nbsp;</label></span>

                        <input type='file' id="imageUploadmlthemeone70" accept=".png, .jpg, .jpeg" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="text-container boxmlthemeone28 textmlthemeone28">
                           ...
                           <span class="savemlthemeone28">save</span>

                            <h1 class="h1-large">Loans Credit Landing Page</h1>
                            <p class="p-large">Submit the form and one of our Credit Counselors will get in touch with you for the loan quotation. Scroll down to see the complete list of loan options</p>
                        </div>
                    </div> <!-- end of col -->
