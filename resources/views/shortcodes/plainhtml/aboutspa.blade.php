...
<p>Its all about building a solid ICO project that aims to solve the pain points in the industry. Pyrupay is supporting the cryptocurrency industry while helping the people within it.</p>

<p>Positioning, Marketing and Publicity are as important as the project itself.</p>

<p>We, at Pyrupay provide an exclusive platform to launch an ICO and pre-token sale which can bring in remarkable success in Cryptocurrency platform. Cryptocurrency platform has many major hurdles that currently plague in the industry. We help businesses who believe that cryptocurrency is the next frontier in the world of money and finance.</p>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="team-member">
                <div class="team-img">
                    <center><img src="{{asset('img/avatar5.png')}}" alt="team member" class="img-responsive"></center>
                </div>
        ...
        <div class="col-md-4 col-sm-4">
            <div class="team-member">
                <div class="team-img">
                   <center>  <img src="{{asset('img/avatar3.png')}}" alt="team member" class="img-responsive"></center>
                </div>
                <div class="team-hover">
                    <div class="desk">
                        <h4>Hello World</h4>
        ...
        <div class="col-md-4 col-sm-4">
            <div class="team-member">
                <div class="team-img">
                    <center> <img src="{{asset('img/avatar04.png')}}" alt="team member" class="img-responsive"></center>
                </div>
                <div class="team-hover">
                    <div class="desk">
