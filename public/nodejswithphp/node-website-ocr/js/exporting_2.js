    ...
    x.exporting = {
        ...
        p(A.prototype, {
            ...
            exportChart: function(c, a) {
                var c = c || {}, d = this.options.exporting,
                d = this.getSVG(o({
                    chart: {
                        borderRadius: 0
                    }
            ...
            destroyExport: function(c) {
                ...
                for (a = 0; a < c.exportSVGElements.length; a++)
                    if (d = c.exportSVGElements[a]) d.onclick = d.ontouchstart = null, c.exportSVGElements[a] = d.destroy();
                for (a =
