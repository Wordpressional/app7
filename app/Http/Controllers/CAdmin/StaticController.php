...
class StaticController extends Controller
{
    ...
    public function downloadStarterStatic()
    {
        ...
        return view('cadmin.static.starterform')->with(['company' => $company, 'data' => $data,'filedata' => $filedata, 'url' => $url]);
    }
...
EOF;
        ...
        Session::flash('success', 'You succesfully Saved the URLs.');
         return redirect()->route('cadmin.static.starterform');
    }
    ...
    public function indexmailconfig()
    {
        ...
        return view('cadmin.mailconfigs.index')->with(['mailconfs' => $nmailconf,'data' => $data]);
    }
    ...
    {
        $data = $this->brandsAll();
        return view('cadmin.mailconfigs.create',compact('data'));
    }
...
EOF;
        ...
        return redirect()->route('cadmin.mailconfig.indexmailconfig');
    ...
    public function editmailconfig($id)
    {
        ...
        return view('cadmin.mailconfigs.edit')->with(['mailconf' => $mailconf, 'data' => $data]);
    }
    ...
    public function viewmailconfig($id)
    {
        ...
        return view('cadmin.mailconfigs.viewm')->with(['mailconf' => $mailconf, 'data' => $data, 'content' => $content]);
    }
