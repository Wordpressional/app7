...
class StablesController extends Controller
{
    ...
    {   
       ...
       if($thisuser->isSuperadministrator() == "yes" || $thisuser->isCMSAdmin()) {
        ...
        return view('cadmin.stables.index',compact('stables','data'));
    }
     /**
    ...
    public function edit($id)
    {
       ...
       $tablecontents = DB::table($tablename)->select('*')->get();
        ...
        $data = $this->brandsAll();
        return view('cadmin.stables.edit')->with(['tablecontents' => $tablecontents, 'stables' => $stables, 'stablescform' => $stablescform, 'stablef' => $stablef, 'alldata' => $alldata,'data' => $data]);
    ...
    public function preview($id)
    {
        ...
        $cform = Cform::find($id);
        return view('cadmin.cforms.preview')->with('cform', $cform);
    }
